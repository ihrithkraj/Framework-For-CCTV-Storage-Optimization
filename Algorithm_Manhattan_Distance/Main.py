...
# importing the function from Manhattan_dist.py for manhattan distance
...
ret, old_frame = cap.read() # reading the first frame of the video
...
while ret:  # while ret is true, the program will continue
    ...
    ret, frame = cap.read()
    # calculates the manhattan distance between the two frames and stores it in sime variable
    sime = manhattan_distance(frame, old_frame)
    ...
    if (sime > 92000):  # if the manhattan distance is greater than 92000 then the program will continue
    ...
    with open('logfiles.txt', 'a') as the_file:
        stringto = "Object '"+label+"' was detected in camera with confidence level '"+confidence+"' having manhattan distance '" + \
...
# input video path=> C:\Users\hr\OneDrive\Desktop\CCTV-Data-Processing\Algorithm\test_video_1.mp4
# output video path=> C:\Users\hr\OneDrive\Desktop\CCTV-Data-Processing\Algorithm\test_video_output.avi
